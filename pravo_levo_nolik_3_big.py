...
propusk_lev = 0
propusk_prv = 0
for i in range(1499, 1500):  # while (ik < 1): # количество файлов
    # ik = ik + 1
    ...
    while (steps < len(viborka)):
        ...
        steps = steps + 1
        if old_key > -1:
            if ((old_key == 1) or (old_key == 2) or (old_key == 3) or (old_key == 4) or (old_key == 5) or (old_key == 6)or (old_key == 7)or (old_key == 8)or (old_key == 9)or (old_key == 10) or (old_key == 11) or (old_key == 12))\
                    and ((key1 == 1) or (key1 == 2) or (key1 == 3) or (key1 == 4) or (key1 == 5) or (key1 == 6)or (key1 == 7) or (key1 == 8)or (key1 == 9)or (key1 == 10) or (key1 == 11) or (key1 == 12)):
                same = same+1
                propusk_sam=0
            ...
            if ((old_key == 1) or (old_key == 2) or (old_key == 3) or (old_key == 4) or (old_key == 5) or (old_key == 6) or (old_key == 7) or (old_key == 8) or (old_key == 9) or (old_key == 10) or (old_key == 11) or (old_key == 12))\
                    and ((key1 == 13) or (key1 == 14) or (key1 == 15) or (key1 == 16) or (key1 == 17) or(key1 == 18) or (key1 == 19)or (key1 == 20) or (key1 == 21) or (key1 == 22) or (key1 == 23) or (key1 == 24)):
                pravo = pravo+1
                propusk_prv = 0
                ...
                # index_prv = pravo / steps
            if ((old_key == 1) or (old_key == 2) or (old_key == 3) or (old_key == 4) or (old_key == 5) or (old_key == 6)or (old_key == 7)or (old_key == 8)or (old_key == 9)or (old_key == 10) or (old_key == 11) or (old_key == 12))\
                    and ((key1 == 25) or (key1 == 26) or (key1 == 27) or (key1 == 28) or (key1 == 29) or (key1 == 30) or (key1 == 31)or (key1 == 32) or (key1 == 33) or (key1 == 34) or (key1 == 35) or (key1 == 36)):
                levo = levo+1
                propusk_lev = 0
                propusk_sam = propusk_sam + 1
                propusk_prv = propusk_prv + 1
                ...
                # index_lev = levo / steps
                # index_prv = pravo / steps
            if ((old_key == 13) or (old_key == 14) or (old_key == 15) or (old_key == 16) or (old_key == 17) or (old_key == 18) or (old_key == 19) or (old_key == 20) or (old_key == 21) or (old_key == 22) or (old_key == 23) or (old_key == 24)) \
                    and ((key1 == 13) or (key1 == 14) or (key1 == 15) or (key1 == 16) or (key1 == 17) or (key1 == 18) or (key1 == 19) or (key1 == 20) or (key1 == 21) or (key1 == 22) or (key1 == 23) or (key1 == 24)):
                same = same + 1
                propusk_sam = 0
                propusk_lev = propusk_lev + 1
            ...
            if ((old_key == 25) or (old_key == 26) or (old_key == 27) or (old_key == 28) or (old_key == 29) or (old_key == 30) or (old_key == 31) or (old_key == 32) or (old_key == 33) or (old_key == 34) or (old_key == 35) or (old_key == 36)) \
                    and ((key1 == 25) or (key1 == 26) or (key1 == 27) or (key1 == 28) or (key1 == 29) or (key1 == 30) or (key1 == 31) or (key1 == 32) or (key1 == 33) or (key1 == 34) or (key1 == 35) or (key1 == 36)):
                same = same + 1
                propusk_sam = 0
                propusk_lev = propusk_lev + 1
